#BIOPHYSICAL MODEL similar to that described in Buckley 2008 Am Nat

#Load function below and then here is a template for running the function.
svl=67
biophys(Taira=25, Ta=30, WIND=0.1, SVL=svl, MASS=massfromsvl(svl), psi=0.6, rho_S=0.7, elevation=500, J=200)


#-------------------
#FUNCTIONS
massfromsvl=function(svl) 3.55*10^-5*(svl)^3.00 #Tinkle and Ballinger 1972 (g)

biophys=function(Taira, Ta, WIND, SVL, MASS, psi, rho_S, elevation, J){
...
return(c(Te, TeS,Te_surf,TeS_surf)) #Returns sun and shade Te for animal in air and on surface
}
